...
## 20: PC = PC + 1; fetch; goto 21
firmware[20] = 0b00010101_000_00110101_001000_001_001

## 21: MAR <- MBR; read; goto 22
firmware[21] = 0b00010110_000_00010100_100000_010_010

## 22: H <- MDR; goto 23
firmware[22] = 0b00010111_000_00010100_000001_000_000

## 23: Y <- Y + H; goto 24
firmware[23] = 0b00011000_000_00111100_000010_000_100

## 24: X <- X - 1; goto 25
firmware[24] = 0b00011001_000_00110110_000100_000_011

## 25: X <- X; if alu == 0 goto 282 else goto 26
firmware[25] = 0b00011010_001_00010100_000100_000_011

## 26: goto 23
firmware[26] = 0b00010111_000_00000000_000000_000_000

## 282: X <- Y; goto 0
firmware[286] = 0b00000000_000_00010100_000100_000_100
